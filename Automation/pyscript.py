...
ENV = Environment(loader=FileSystemLoader('c/Users/masa656/github/Cisco-Devnet-Learning-for-Zeus/Automation/templates'))

## Load the basic-baseline.j2 jinja2 template file
baseline = ENV.get_template("cisco-sample.j2")

## Open the YAML file and render config
with open("cisco-yaml-file.yaml") as y:
